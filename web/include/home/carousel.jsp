...
<div id="carousel-of-product"  class="carousel-of-product carousel slide1" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img class="carousel carouselImage" src="<%=request.getContextPath()%>/img/lunbo/1.jpg" >
    </div>
    <div class="item">
      <img  class="carouselImage" src="<%=request.getContextPath()%>/img/lunbo/2.jpg" >
    </div>
    <div class="item">
		<img  class="carouselImage" src="<%=request.getContextPath()%>/img/lunbo/3.jpg" >
    </div>

    <div class="item">
        <img  class="carouselImage" src="<%=request.getContextPath()%>/img/lunbo/4.jpg" >
    </div>
